...
//  this->data(0x07);  // 0000 0111 = Border LDO disable, VDHR internal, VDH/VDL internal, VGH/VGL internal
//  this->data(0x17);  // VGH&VGL // 0001 0111 = VCOM 1, VGH=20V, VGL=-20V
//  this->data(0x3F);  // VDH     // 0011 1111 = 15.0V
//  this->data(0x26);  // VDL     // 0001 0110 = -6.8V
//  this->data(0x11);  // VDHR    // 0001 0001 =  5.8V
...
//  this->data(0x07);  // 0000 0111 = Border LDO disable, VDHR internal, VDH/VDL internal, VGH/VGL internal
//  this->data(0x07);  // VGH&VGL // 0001 0111 = VCOM 1, VGH=20V, VGL=-20V
//  this->data(0x3F);  // VDH     // 0011 1111 = 15.0V
//  this->data(0x3F);  // VDL     // 0001 0110 = -6.8V

  // VCOM DC Setting
//  this->command(0x82);
//  this->data(0b00100100);  // VCOM = -1.9V
...
//  this->data(0b00001111);
  // D7 =0: DC
  // D6 =0: DC
  // D5 =1: LUT, 0=from OTP, 1=from register (non-default)
  // D4 =1: KW/R, 0=B/W/R, 1=B/W    <- this probably needs changing
  // D3 =1: Gate scan direction, 0=scan down, 1=scan up (default)
  // D2 =1: Source shift direction, 0=shift left, 1=shift right (default)
  // D1 =1: Booster switch, 0=disable, 1=enable (default)
  // D0 =1: Soft reset, 0=reset, 1=no effect (default)
...
//  // COMMAND VCOM AND DATA INTERVAL SETTING
//  this->command(0x50);
//  this->data(0b00110001);
//  this->data(0b00000111);
//  // COMMAND TCON SETTING
//  this->command(0x60);
//  this->data(0x22);
//  // Resolution setting
...
//  };
//
//  // TODO: identify if we want to drop the LUTs in KWR
//  uint8_t count;
...
void HOT WaveshareEPaper7P5InBV3::display() {
  ...
  // - Writes to K/W in KWR-mode
  // - Bit = 0 is white, 1 is black
  // - Bit for pixel is ignored if R is set in the next transmission
  this->command(0x10);
  for (uint32_t i = 0; i < buf_len_half; i++) {
    this->data(~this->buffer_[i]);
  }
  ...
  // - Writes to RED in KWR-mode
  // - Bit = 1 is red, 0 ignored
  this->command(0x13);
  delay(2);
  for (uint32_t i = 0; i < buf_len_half; i++) {
    this->data(this->buffer_[i + buf_len_half]);
  }
